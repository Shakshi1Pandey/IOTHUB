...
console.log(req.body);
    if(!req.body.deviceName || !req.body.clientId || !req.body.deviceType || !req.body.branchId || !req.body.deviceId || !req.body.brand, || !req.body.regionId || !assetId || !req.body.serialNo || !req.body.simno ){
